...
describe("Teste - Login", () => {
 ...
 // #################################################################################################
// #                                                                                               #
// #                        VEREFICA SE A VITRINE PUBLICA ESTÁ DISPONIVEL PRO PERFIL ALUNO                              #
// #                                                                                               #
// #################################################################################################
...
cy.get('li[ng-if="breadcrumb.showcaseNameRoute"]', { timeout: 10000 })
  .should('contain.text', 'Vitrine Portugues Cypress');
      ...
      // #################################################################################################
// #                                                                                               #
// #                         TESTE DE PERMISSÃO DE CARGO (GRUPO- 2)                                #
// #                                                                                               #
// #################################################################################################
...
cy.get('span.text-area[title="Primeira Vitrine Cypress"]', { timeout: 60000 }).should('be.visible')
      ...
      it('Clica no botão Editar da vitrine', () => {
  const clicarEditarVitrine = (tentativa = 1) => {
    cy.get('body').then(($body) => {
      ...
      if (editarDisponivel) {
        cy.contains('tr', 'Vitrine Portugues Cypress', { timeout: 10000 }).within(() => {
...
cy.get('li[ng-if="breadcrumb.showcaseNameRoute"]', { timeout: 10000 })
 ...
 it('Não exibe a vitrine para usuário fora do grupo', () => {
  ...
  cy.get('#showcaseNavigation2026', { timeout: 10000 })
    .should('be.visible')
    .and('not.contain.text', 'Vitrine Portugues Cypress');

  cy.contains('#showcaseNavigation2026 span.ng-binding', 'Vitrine Portugues Cypress')
    .should('not.exist');

    });

    it('Exclui a Permissão (Grupo - 2)', () => {
...
it('Clica na vitrine', () => {
  ...
  //Clica na lixeira para excluir a pemissão de grupo (Analista de Testes JR)
  cy.get('tr.ng-scope > :nth-child(4) > .middle > .btn')
  .should('be.visible')
  .click({ force: true });
...
cy.get('li[ng-if="breadcrumb.showcaseNameRoute"]', { timeout: 10000 })
  .should('contain.text', 'Vitrine Portugues Cypress');
              ...
              it('Entra em outro perfil que não faz parte da unidade (Outro)', () => {
    ...
    cy.url({ timeout: 60000 }).should("not.include", "/subscribe/login");
     ...
     it('Não exibe a vitrine para usuário de outra unidade', () => {
...
it('Clica na vitrine', () => {
  ...
  //Clica na lixeira para excluir a pemissão de unidade (Outro)
  cy.get('tr.ng-scope > :nth-child(4) > .middle > .btn')
  .should('be.visible')
  .click({ force: true });
  ...
  cy.wait(5000);
          ...
          it('Entra no perfil que faz parte da unidade "Outro" e verefica que a vitrine não esteja mais disponivel', () => {
  ...
  cy.contains('#showcaseNavigation2026 span.ng-binding', 'Vitrine Portugues Cypress')
    ...
    // #################################################################################################
// #                                                                                               #
// #                         TESTE DE PERMISSÃO DE PERFIL (Aluno)                               #
// #                                                                                               #
// #################################################################################################



 it('Adicina Permissão Aluno', () => {
...
cy.get('span.text-area[title="Primeira Vitrine Cypress"]', { timeout: 60000 }).should('be.visible')
  ...
  // Continuação do seu teste aqui
   ...
   it('Adiciona Permição de Perfil aluno', () => {
...
// Seleciona a opção Aluno
cy.get('.ui-select-choices-row:visible span[title="Aluno"]', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true })
...
cy.get('li[ng-if="breadcrumb.showcaseNameRoute"]', { timeout: 10000 })
  .should('contain.text', 'Vitrine Portugues Cypress');
        ...
        it('Entra na vitrine na visão publuca', () => {

  cy.visit('https://hml.lector.live/lector_suporte/showcase/2257')
...
it('Clica na vitrine', () => {
  ...
  cy.wait(5000);
          ...
          it('Entra no perfil que "Aluno" e verefica que a vitrine não esteja mais disponivel', () => {
...
cy.get('.ui-select-choices:visible', { timeout: 10000 })
  ...
  cy.contains('table tbody tr', 'Vitrine Portugues Cypress', { timeout: 10000 }).should('not.exist')
})
...
it('Clica na categoria LECTOR (Não mexer) e verifica se aparece a vitrine nesta categoria', () => {
  ...
  cy.contains('div.ng-binding', 'BANNER 2906', { timeout: 60000 }).should('be.visible')
      ...
      it('Verifica que a vitrine está na categoria', () => {
        ...
        cy.contains('table tbody div.ng-binding', 'Vitrine Portugues Cypress', { timeout: 60000 })
  .should('be.visible')
...
it('Joga a vitrine pra categoria todos', () => {
  ...
  cy.contains('table tbody tr', 'Vitrine Portugues Cypress', { timeout: 60000 })
  .should('be.visible')
  .within(() => {
...
cy.get('.ui-select-choices:visible', { timeout: 10000 })
  ...
  cy.get('body').then(($body) => {
    const apareceu = $body.find('table tbody div.ng-binding:contains("Vitrine Portugues Cypress"):visible').length > 0
...
cy.contains('table tbody div.ng-binding', 'Vitrine Portugues Cypress', { timeout: 60000 }).should('be.visible')
